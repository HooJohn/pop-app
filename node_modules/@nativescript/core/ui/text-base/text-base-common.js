...
import { parseCSSStroke } from '../styling/css-stroke';
...
export const iosTextAnimationProperty = new Property({
...
const textAlignmentConverter = makeParser(makeValidator('left', 'center', 'right', 'justify'));
...
const textTransformConverter = makeParser(makeValidator('none', 'capitalize', 'uppercase', 'lowercase'));
export const textTransformProperty = new InheritedCssProperty({
    name: 'textTransform',
...
export const textShadowProperty = new InheritedCssProperty({
    name: 'textShadow',
    cssName: 'text-shadow',
...
export const textStrokeProperty = new InheritedCssProperty({
    name: 'textStroke',
    cssName: 'text-stroke',
    affectsLayout: __APPLE__,
    valueConverter: (value) => {
...
const whiteSpaceConverter = makeParser(makeValidator('normal', 'nowrap'));
export const whiteSpaceProperty = new InheritedCssProperty({
    name: 'whiteSpace',
    cssName: 'white-space',
    defaultValue: 'initial',
    affectsLayout: __APPLE__,
...
const textOverflowConverter = makeParser(makeValidator('clip', 'ellipsis'));
